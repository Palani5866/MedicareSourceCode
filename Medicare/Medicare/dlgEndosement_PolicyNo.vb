...
Imports System.IO
Public Class dlgEndosement_PolicyNo
...
#End Region
#Region "Page Events"
    Private Sub dlgEndosement_PolicyNo_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        If Conn.State = ConnectionState.Open Then
            Conn.Close()
        End If
    End Sub
    Private Sub dlgEndosement_PolicyNo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "General Functions/Subs"
    ...
    Private Function Endorse_Changes() As Boolean
        ...
        Try
            ...
            If Not IsDBNull(ds_Endorsement.Tables(0).Rows(0)("Policy_No")) Then
                Me.lblOldPolicyNO.Text = ds_Endorsement.Tables(0).Rows(0)("Policy_No").ToString.Trim()
            Else
                Me.lblOldPolicyNO.Text = ""
            End If
            If Not IsDBNull(ds_Endorsement.Tables(0).Rows(0)("New_Policy_No")) Then
                Me.lblNewPolicyNo1.Text = ds_Endorsement.Tables(0).Rows(0)("New_Policy_No").ToString.Trim()
            Else
                Me.lblNewPolicyNo1.Text = ""
            End If
            With ds_Endorsement.Tables("dt_Member_Policy").Rows(0)
                .Item("Policy_No") = Me.txtPolicyNo.Text.ToUpper.Trim
                .Item("New_Policy_No") = Me.txtNewPolicyNo.Text.ToUpper.Trim
            ...
            With dr_MemberLog
                ...
                .Item("Log_Date") = Now()
                .Item("Activity_Detail") = "Change Policy/Certificate No."
            ...
            With dr_Member_Endorsement_New
                ...
                .Item("Endorsement_Detail") = "Change Policy/Certificate No. From : " & Me.lblOldPolicyNO.Text & " To : " & Me.txtPolicyNo.Text.ToString.Trim() & " Or Change New Policy From : " & Me.lblNewPolicyNo.Text & " To : " & Me.txtNewPolicyNo.Text.Trim()
                .Item("Request_Date") = Me.dtpRequestedDate.Value
                .Item("Remark") = Me.txtRemark.Text.ToString.Trim
                .Item("TRANS_TYPE") = "CHANGE OF POLICY NO"
