...
Public Class Due_to_60_PercentPA
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Due_to_60_PercentPA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDue_to_60_PercentPA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Due_to_60_PercentPA = New Due_to_60_PercentPA
        rpt.Site = Me.Site
        Return rpt
    End Function
