...
Public Class underwritingLetterP1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "underwritingLetterP1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_sYear() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedunderwritingLetterP1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As underwritingLetterP1 = New underwritingLetterP1
        rpt.Site = Me.Site
        Return rpt
    End Function
