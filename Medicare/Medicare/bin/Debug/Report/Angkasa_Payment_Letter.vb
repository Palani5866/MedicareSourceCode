...
Public Class Angkasa_Payment_Letter
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Angkasa_Payment_Letter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAngkasa_Payment_Letter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Angkasa_Payment_Letter = New Angkasa_Payment_Letter
        rpt.Site = Me.Site
        Return rpt
    End Function
