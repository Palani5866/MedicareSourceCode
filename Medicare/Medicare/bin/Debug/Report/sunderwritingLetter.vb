...
Public Class sunderwritingLetter
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "sunderwritingLetter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsunderwritingLetter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As sunderwritingLetter = New sunderwritingLetter
        rpt.Site = Me.Site
        Return rpt
    End Function
