...
Public Class underwritingLetterP2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "underwritingLetterP2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedunderwritingLetterP2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As underwritingLetterP2 = New underwritingLetterP2
        rpt.Site = Me.Site
        Return rpt
    End Function
