Imports System.IO
Public Class rShortFall
    Dim _objBusi As New Business
    Dim Conn As DbConnection = New SqlConnection()
    Dim sType, BatchNo As String

    Private Sub rShortFall_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        If Conn.State = ConnectionState.Open Then
            Conn.Close()
        End If
    End Sub
    Private Sub rShortFall_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        BINDCB()
        BINDDATA()
        BatchNo = Format(Now.Date, "yyMMdd") & "-" & Format(Now, "HHmmss")
    End Sub
    Private Sub BINDCB()
        ...
        If dtBatchNo.Rows.Count > 0 Then
            Me.tscbRequestBatchNo.ComboBox.DataSource = dtBatchNo
            Me.tscbRequestBatchNo.ComboBox.DisplayMember = "request_batch_no"
            Me.tscbRequestBatchNo.ComboBox.ValueMember = "request_batch_no"
        Else
            Me.tscbRequestBatchNo.ComboBox.DataSource = dtBatchNo
        End If
    End Sub
    ...
    Private Sub dgvShortFalls_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvShortFalls.CellDoubleClick
        With Me.dgvShortFalls
            ...
            Else
                ...
                rSF.txtShortAmt.Text = FormatNumber(.SelectedRows(0).Cells(10).Value.ToString.Trim.Replace("-", ""), 2)
                rSF.txtRequestedAmt.Text = FormatNumber(.SelectedRows(0).Cells(10).Value.ToString.Trim.Replace("-", ""), 2)
        ...
        End With
    End Sub
    Private Sub lbXport2Xcel_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lbXport2Xcel.LinkClicked
        XPort2Xcel()
    End Sub
