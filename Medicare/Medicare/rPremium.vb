...
Public Class rPremium
    ...
    Private Sub rPremium_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        If Conn.State = ConnectionState.Open Then
            Conn.Close()
        End If
    End Sub
    Private Sub rPremium_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub BINDDATA()
        ...
        Select Case Me.lblRF1.Text.Trim()
            Case "CCNEW"
                dt = _objBusi.fPI("CC", Me.tsReport_ddlMonth.Text.ToString.Trim(), "", "", "", "", "", "", "", "CCNEW", "INCREASE", Conn)
            Case "CCOLD"
                dt = _objBusi.fPI("CC", Me.tsReport_ddlMonth.Text.ToString.Trim(), "", "", "", "", "", "", "", "CCOLD", "INCREASE", Conn)
            Case "CPANEW"
                dt = _objBusi.fPI("CPA", Me.tsReport_ddlMonth.Text.ToString.Trim(), "", "", "", "", "", "", "", "CPANEW", "INCREASE", Conn)
            Case "CPAOLD"
                dt = _objBusi.fPI("CPA", Me.tsReport_ddlMonth.Text.ToString.Trim(), "", "", "", "", "", "", "", "CPAOLD", "INCREASE", Conn)
        End Select
    ...
    Private Sub BINDDATAD()
        ...
        dtPI = _objBusi.fPI("CC", Me.lblRF1.Text.Trim(), "", "", "", "", "", "", "", "REQUESTED", "INCREASE", Conn)
