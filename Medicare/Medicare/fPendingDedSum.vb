Public Class fPendingDedSum
#Region "Global Veriable"
    Dim Conn As DbConnection = New SqlConnection
    Dim _ObjBusi As New Business
    Dim DateTo, DateFrom As String
#End Region
    Private Sub fPendingDedSum_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        If Conn.State = ConnectionState.Open Then
            Conn.Close()
        End If
    End Sub
    Private Sub fPendingDedSum_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Select Case Me.lblP1.Text.ToString.Trim()
            Case "PDS"
        ...
        With Me.dgvPDetails
            If e.ColumnIndex = 0 Then
                If .Rows.Count = 0 Then
                    Exit Sub
                End If
                If Not .Rows(e.RowIndex).Cells(0).Value = "0" Then
                    Dim vSFD As New frmSummaryDetails
                    Select Case Me.lblP1.Text.ToString.Trim()
                        Case "PDS"
                            vSFD.lblP1.Text = "PDSD"
                        Case "NCS"
                            vSFD.lblP1.Text = "NCSD"
                        Case "EPS"
                            vSFD.lblP1.Text = "EPSD"
                        Case "SS"
                            vSFD.lblP1.Text = "SSD"
                    End Select
            ...
            ElseIf e.ColumnIndex = 1 Then
                ...
                If Not .Rows(e.RowIndex).Cells(1).Value = "0" Then
                    ...
                    vSFD.lblP2.Text = DateFrom
                    vSFD.lblP3.Text = DateTo
                    vSFD.lblP4.Text = .Rows(e.RowIndex).Cells(1).Value.ToString.Trim()
            ...
            ElseIf e.ColumnIndex = 2 Then
                ...
                If Not .Rows(e.RowIndex).Cells(2).Value = "0" Then
                    ...
                    vSFD.lblP2.Text = DateFrom
                    vSFD.lblP3.Text = DateTo
                    vSFD.lblP4.Text = .Rows(e.RowIndex).Cells(2).Value.ToString.Trim()
            ...
            ElseIf e.ColumnIndex = 3 Then
                ...
                If Not .Rows(e.RowIndex).Cells(3).Value = "0" Then
                    ...
                    vSFD.lblP2.Text = DateFrom
                    vSFD.lblP3.Text = DateTo
                    vSFD.lblP4.Text = .Rows(e.RowIndex).Cells(3).Value.ToString.Trim()
            ...
            ElseIf e.ColumnIndex = 4 Then
                ...
                If Not .Rows(e.RowIndex).Cells(4).Value = "0" Then
                    ...
                    vSFD.lblP2.Text = DateFrom
                    vSFD.lblP3.Text = DateTo
                    vSFD.lblP4.Text = .Rows(e.RowIndex).Cells(4).Value.ToString.Trim()
            ...
            ElseIf e.ColumnIndex = 5 Then
                ...
                If Not .Rows(e.RowIndex).Cells(5).Value = "0" Then
                    ...
                    vSFD.lblP2.Text = DateFrom
                    vSFD.lblP3.Text = DateTo
                    vSFD.lblP4.Text = .Rows(e.RowIndex).Cells(5).Value.ToString.Trim()
