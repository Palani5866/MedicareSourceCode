...
Public Class fPolicyPremiumIncrease
#Region "Global Veriable"
    Dim _objBusi As New Business
    Dim Conn As DbConnection = New SqlConnection()
#End Region
    Private Sub fPolicyPremiumIncrease_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        If Conn.State = ConnectionState.Open Then
            Conn.Close()
        End If
    End Sub
    Private Sub fPolicyPremiumIncrease_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub BINDDATA()
        ...
        If dsR.Tables(0).Rows.Count > 0 Then
            With Me.dgvJanPIR
                ...
                .Columns(0).DisplayIndex = 12
                .Columns(1).DisplayIndex = 12
    ...
    Private Sub dgvJanPIPR_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvJanPIPR.CellContentClick
        With Me.dgvJanPIPR
            ...
            ElseIf e.ColumnIndex = 2 Then
                ...
                End If
                Dim sRes As String
                sRes = _objBusi.spUpdate("PIUP", .Rows(e.RowIndex).Cells(3).Value.ToString().Trim(), My.Settings.Username().ToUpper.ToString(), "", "", "", "", "", "", "", "", Conn)
    ...
    Private Sub dgvFebPIPR_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvFebPIPR.CellContentClick
        With Me.dgvFebPIPR
            ...
            ElseIf e.ColumnIndex = 2 Then
                ...
                End If
                Dim sRes As String
                sRes = _objBusi.spUpdate("PIUP", .Rows(e.RowIndex).Cells(3).Value.ToString(), My.Settings.Username().ToUpper.ToString(), "", "", "", "", "", "", "", "", Conn)
                BINDDATA()
                If sRes = "1" Then
                    MsgBox("Successfully Requested the Increase Premium")
                Else
    ...
    Private Sub dgvJanPIR_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvJanPIR.CellContentClick
        With Me.dgvJanPIR
            ...
            ElseIf e.ColumnIndex = 1 Then
                ...
                End If
                Dim sRes As String
                sRes = _objBusi.spUpdate("PIUP", .Rows(e.RowIndex).Cells(2).Value.ToString(), My.Settings.Username().ToUpper.ToString(), "", "", "", "", "", "", "", "C", Conn)
                _objBusi.spUpdate("PPVERIFY", .Rows(e.RowIndex).Cells(2).Value.ToString().Trim(), "Premium Increase Request for " & .Rows(e.RowIndex).Cells(8).Value.ToString().Trim() & " has been confirmed!", My.Settings.Username().ToUpper.ToString(), "", "", "", "", "", "", "", Conn)
                BINDDATA()
                If sRes = "1" Then
    ...
    Private Sub dgvSepPIR_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvSepPIR.CellContentClick
        ...
        End With
    End Sub
    Private Sub dgvOctPIR_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvOctPIR.CellContentClick
        With Me.dgvOctPIR
            If e.ColumnIndex = 0 Then
                If .Rows.Count = 0 Then
                    Exit Sub
