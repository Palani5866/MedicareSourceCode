...
#End Region
#Region "Page Events"
    Private Sub fUploadCID_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        If Conn.State = ConnectionState.Open Then
            Conn.Close()
        End If
    End Sub
    Private Sub fUploadCID_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "Click Events"
    ...
    Private Sub btnUpload_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        If Me.lblType.Text = "VALIDATION" Then
            fvClientID()
        Else
            InsXportData()
        End If
...
#End Region
#Region "Upload"
    Private Function fvClientID() As String
        ...
        For Each dr As DataRow In dt.Rows
            If iCount >= 0 Then
                ...
                xWB.Worksheets(xWName).Cells(xRowCount, 5) = "'" & dr(7)
                xWB.Worksheets(xWName).Cells(xRowCount, 6) = "'" & certM
                sRes = _objBusi.fValidateClientID("CLIENTNO", dr(3).ToString.Trim(), dr(7).ToString.Trim(), dr(8).ToString.Trim(), dr(9).ToString.Trim(), dr(37).ToString.Trim(), MemIC, MemName, certM, "", "", "", "", "", "", My.Settings.Username.Trim, Conn)
                xWB.Worksheets(xWName).Cells(xRowCount, 7) = "'" & sRes
            End If
            xRowCount += 1
            iCount += 1
